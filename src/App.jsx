  ...
  return <>
    ...
    <main id="top">
      <section className="hero content" aria-labelledby="hero-title">
        ...
        <div className="hero-actions"><DownloadButton/><span className="size-note">Apple Silicon · 150 KB DMG · Free</span></div>
      </section>
      ...
      <section className="download" id="download"><div className="content"><h2>Get Quantum.</h2><div className="download-option"><Apple size={20}/><span>macOS · Apple Silicon</span><span className="download-tag">150 KB DMG</span><DownloadButton className="download-final" children="Download"/></div><p className="install-note">macOS 15+ · First launch: System Settings → Privacy & Security → Open Anyway.</p></div></section>
    </main>
    <footer className="footer"><div className="content"><a className="brand" href="#top"><Mark size={20}/> quantum</a><a href={REPO} target="_blank" rel="noopener noreferrer">GitHub <Arrow size={15}/></a></div></footer>
  </>;
}